    ...
    return (
      <div className="app">
        <Route path="/search" render={() => (
          <BookSearch bookshelves={this.bookshelves} books={this.state.books} />
        )} />
        <Route exact path="/" render={() => (
          <BookList bookshelves={this.bookshelves} books={this.state.books} />
        )} />
      </div>
    )
  }
      ...
      <li>
        <div className="book">
          <div className="book-top">
            ...
            <BookShelfChanger currentShelf={this.props.bookDetails.shelf} />
          </div>
          <div className="book-title">
            {this.props.bookDetails.title}
          </div>
          <div className="book-authors">{this.props.bookDetails.authors.map(author => (
            author + " "
          ))}</div>
        </div>
      </li>
  ...
  render() {
    return (
      <div className="book-shelf-changer">
        <select value={this.props.currentShelf} onChange={() => alert("changed")}>
      ...
      <div className="list-books-content">
        <div>
          {this.props.bookshelves.map(shelf => (
            <BookShelf key={shelf.key} shelf={shelf} books={this.props.books} />
          ))}
        </div>
      </div>
    )
  ...
  render() {
    return (
      <div className="list-books">
        ...
        <BookCase bookshelves={this.props.bookshelves} books={this.props.books} />
        <OpenSearch />
      </div>
    )
  }
